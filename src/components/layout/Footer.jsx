        ...
        <div className="container-max mx-auto px-4 sm:px-6 lg:px-8 py-10 flex flex-col sm:flex-row items-center justify-between gap-6">
          ...
          <div className="flex flex-wrap gap-2 sm:gap-3">
            <button
              ...
              className="btn-secondary !bg-white !text-primary-700 !border-white hover:!bg-white/90 whitespace-nowrap text-sm sm:text-base py-2.5 sm:py-3 px-4 sm:px-5"
            >
              Book Appointment
            </button>
            <button
              onClick={() => openWhatsAppChat(doctor.whatsapp)}
              className="btn-secondary whitespace-nowrap text-sm sm:text-base py-2.5 sm:py-3 px-4 sm:px-5"
            >
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8 sm:gap-10">
          ...
          <div className="lg:col-span-2">
            <div className="flex items-center gap-2 sm:gap-3 mb-4">
              <div className="w-10 h-10 sm:w-11 sm:h-11 bg-primary-600 rounded-xl flex items-center justify-center font-display font-bold text-base sm:text-lg text-white">
                {doctor.prefix}
              </div>
              <div>
                <div className="font-display font-bold text-white text-sm sm:text-base">{doctor.name}</div>
                <div className="text-primary-400 text-xs font-medium">{clinic.name}</div>
              </div>
            </div>
            <p className="text-white/50 text-sm leading-relaxed max-w-full sm:max-w-sm mb-4 sm:mb-6">
              {footer.tagline}
            </p>
