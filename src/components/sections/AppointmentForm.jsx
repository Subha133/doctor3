        ...
        <div className="grid lg:grid-cols-5 gap-8 sm:gap-10 lg:gap-16 items-start">
          ...
          >
            ...
            <div className="space-y-3 sm:space-y-4 mt-6 sm:mt-8">
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl sm:rounded-2xl shadow-card">
                ...
                <div>
                  ...
                  <a href={doctorData.clinic.mapLink} target="_blank" rel="noreferrer"
                    className="text-slate-500 text-xs leading-relaxed hover:text-primary-600 transition-colors line-clamp-2">
              ...
              <div className="flex items-start gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl sm:rounded-2xl shadow-card">
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-teal-50 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  {doctorData.clinic.workingHours.map((h, i) => (
                    <div key={i} className="flex justify-between text-xs mb-1">
                      <span className="text-slate-500 truncate">{h.day}</span>
                      <span className={`font-semibold whitespace-nowrap ${h.time === "Emergency Only" ? "text-red-500" : "text-slate-700"}`}>
                        {h.time}
                      </span>
                    </div>
                  ))}
              ...
              <div className="flex items-center gap-3 sm:gap-4 p-3 sm:p-4 bg-white rounded-xl sm:rounded-2xl shadow-card">
                <div className="w-9 h-9 sm:w-10 sm:h-10 bg-green-50 rounded-lg sm:rounded-xl flex items-center justify-center flex-shrink-0">
          ...
          >
            <div className="bg-white rounded-2xl sm:rounded-3xl shadow-card p-5 sm:p-6 lg:p-8">
              <h3 className="font-display text-xl sm:text-2xl font-bold text-slate-900 mb-1">Request an Appointment</h3>
              <p className="text-slate-400 text-sm mb-4 sm:mb-6">Fill in the form below. We'll confirm via WhatsApp within 2 hours.</p>

              {submitted && (
                <motion.div
                  initial={{ opacity: 0, scale: 0.95 }}
                  animate={{ opacity: 1, scale: 1 }}
                  className="mb-4 sm:mb-6 p-3 sm:p-4 bg-teal-50 border border-teal-200 rounded-xl sm:rounded-2xl flex items-start gap-2 sm:gap-3"
                >
                  ...
                  <p className="text-teal-800 text-xs sm:text-sm">{appointment.confirmationMessage}</p>
                </motion.div>
              )}
